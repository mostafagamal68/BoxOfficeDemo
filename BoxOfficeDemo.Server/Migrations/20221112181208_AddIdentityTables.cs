    ...
    public partial class AddIdentityTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MovieID = table.Column<decimal>(type: "decimal(28,8)", nullable: false),
                    ...
                    ParentalGuide = table.Column<int>(type: "int", nullable: true),
                    Length = table.Column<TimeSpan>(type: "time", nullable: true),
                    Genere = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReviewID = table.Column<decimal>(type: "decimal(28,8)", nullable: false),
                    UserID = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    MovieID = table.Column<decimal>(type: "decimal(28,8)", nullable: true),
